...
type ComposantToast = React.FunctionComponent<{ close?: any }> & {
  data?: object;
};
...
type TOnCloseCallback<TReturnType extends any> = (
  returnedValue: TReturnType,
) => void;
...
type TDialogContentArg =
  | ComposantToast
  | Promise<{ default: ComposantToast }>
  | TOptsToast;
...
type DialogActions = {
  ...
  info: (
    ...[title, content, boutons, options]: TToastShortcutArgs
  ) => TDialogControls;
...
export const createDialog = (
  ...
  const show = <TReturnType extends any = true>(
    ...
    const promise = new Promise(
      async (resolve: TOnCloseCallback<TReturnType>) => {
        onClose = resolve;
