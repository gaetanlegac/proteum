...
export type TListeErreursSaisie<TClesDonnees extends string = string> = {
  [champ in TClesDonnees]: string[];
};
...
export class Anomaly extends CoreError {
  ...
  public static msgDefaut =
    "A technical error has occurred. A notification has just been sent to the admin.";
