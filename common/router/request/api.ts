...
export type TFetcherList = {
  [id: string]: TFetcher<any> | Promise<any> | undefined;
};
...
export default abstract class ApiClient {
  ...
  public abstract createFetcher<TData extends unknown = unknown>(
    ...args: TFetcherArgs
  ): TFetcher<TData>;

  public abstract fetchSync(
