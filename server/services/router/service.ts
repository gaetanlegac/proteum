...
export type TRouterServiceArgs = [getConfig: TServiceArgs<AnyRouterService>[1], app: Application];

/*----------------------------------
- SERVICE
----------------------------------*/
export default abstract class RouterService<TConfig extends {}, TRouter extends TAnyRouter> extends Service<
    TConfig,
    {},
    Application,
    TRouter
