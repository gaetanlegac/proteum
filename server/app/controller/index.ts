...
import type { TRouterContext, TAnyRouter } from '@server/services/router/response';
...
> {
    ...
    public input<TSchema extends zod.ZodTypeAny>(schema: TSchema): zod.infer<TSchema> {
